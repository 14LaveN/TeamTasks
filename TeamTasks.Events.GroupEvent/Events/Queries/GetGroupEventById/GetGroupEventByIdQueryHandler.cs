...
internal sealed class GetGroupEventByIdQueryHandler : IQueryHandler<GetGroupEventByIdQuery, Maybe<DetailedGroupEventResponse>>
{
    ...
    public GetGroupEventByIdQueryHandler(IDbContext<Domain.Entities.GroupEvent> dbContext, UserDbContext identityDbContext)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        DetailedGroupEventResponse? response = await (
            from groupEvent in _dbContext.Set<Domain.Entities.GroupEvent>().AsNoTracking()

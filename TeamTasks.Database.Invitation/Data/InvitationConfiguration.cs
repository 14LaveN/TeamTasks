...
/// </summary>
internal sealed class InvitationConfiguration : IEntityTypeConfiguration<Domain.Entities.Invitation>
{
    /// <inheritdoc />
    public void Configure(EntityTypeBuilder<Domain.Entities.Invitation> builder)
    {

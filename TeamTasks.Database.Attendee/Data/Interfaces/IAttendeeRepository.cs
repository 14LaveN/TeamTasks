...
namespace TeamTasks.Database.Attendee.Data.Interfaces;
...
public interface IAttendeeRepository
{
    ...
    Task<Maybe<Domain.Entities.Attendee>> GetByIdAsync(Guid attendeeId);
    ...
    Task<IReadOnlyCollection<Domain.Entities.Attendee>> GetUnprocessedAsync(int take);
    ...
    Task Insert(Domain.Entities.Attendee attendee);

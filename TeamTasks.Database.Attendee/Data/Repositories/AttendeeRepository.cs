...
namespace TeamTasks.Database.Attendee.Data.Repositories;

/// <summary>
/// Represents the attendee repository.
/// </summary>
internal sealed class AttendeeRepository : GenericRepository<Domain.Entities.Attendee>, IAttendeeRepository
{
    ...
    public AttendeeRepository(
        BaseDbContext<Domain.Entities.Attendee> dbContext,
    ...
    /// <inheritdoc />
    public async Task<IReadOnlyCollection<Domain.Entities.Attendee>> GetUnprocessedAsync(int take) =>
        await DbContext.Set<Domain.Entities.Attendee>()
    ...
    public async Task<(string Email, string Name)[]> GetEmailsAndNamesForGroupEvent(GroupEvent groupEvent)
    {
        ...
        var attendeeEmailsAndNames = await(
            ...
            join attendee in DbContext.Set<Domain.Entities.Attendee>()

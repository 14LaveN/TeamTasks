...
namespace TeamTasks.Database.Notification.Data.Interfaces;
...
public interface INotificationRepository
{
    ...
    Task<(Domain.Entities.Notification Notification, Event Event, User User)[]> GetNotificationsToBeSentIncludingUserAndEvent(
        int batchSize,
        DateTime utcNow,
    ...
    Task InsertRange(IReadOnlyCollection<Domain.Entities.Notification> notifications);
